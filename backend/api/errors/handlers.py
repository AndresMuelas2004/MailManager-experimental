...
_STATUS_MAP: dict[type[ApiError], int] = {
    ...
    ArchiveMoveError: status.HTTP_502_BAD_GATEWAY,
    ArchiveRestoreError: status.HTTP_502_BAD_GATEWAY,
    ...
    UnreadCountError: status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    FolderNotFound: status.HTTP_404_NOT_FOUND,
    FolderNameConflict: status.HTTP_409_CONFLICT,
    FolderOperationError: status.HTTP_500_INTERNAL_SERVER_ERROR,
    RuleNotFound: status.HTTP_404_NOT_FOUND,
    RuleValidationError: status.HTTP_422_UNPROCESSABLE_ENTITY,
    RuleOperationError: status.HTTP_500_INTERNAL_SERVER_ERROR,
    RuleApplyStatusError: status.HTTP_500_INTERNAL_SERVER_ERROR,
