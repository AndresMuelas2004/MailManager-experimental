...
- **La carga de la cadena falla al abrir** (fallo del proveedor al reconstruir el hilo): el **correo que abriste sigue visible** —su cuerpo ya se había pintado desde la caché— y solo aparece un **aviso discreto** de que no se pudo cargar el resto de la conversación, en lugar de reemplazar toda la ventana por un error como ocurría antes (§ 3).
