...
- [autenticacion-y-cuentas.md](autenticacion-y-cuentas.md) — Login con Google, sesión de la app, y conectar / editar / desconectar cuentas de Gmail y Outlook.
...
- [listado-de-correos.md](listado-de-correos.md) — Las cuatro bandejas reales, el orden, y por qué cada acción va al buzón real del correo.
