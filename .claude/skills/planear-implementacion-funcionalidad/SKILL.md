...
El producto de las tres rondas es, por cada par (API, tema), un único `.md` de investigación de la máxima calidad que entra como contexto en la fase de resolución de dudas.
